...
execute positioned ~ ~-1 ~ if entity @e[distance=..1,tag=!corem.raycast.area,tag=!corem.raycast.mark,type=!#corem:1.17/raycast] unless entity @s positioned ~ ~1 ~ run function corem:raycast/end
...
execute if block ~ ~ ~ #corem:air as @s[scores={corem.raycast=..200}] positioned ^ ^ ^0.5 run function corem:raycast/1.17/tick