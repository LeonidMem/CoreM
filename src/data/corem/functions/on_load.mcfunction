...
#% scoreboard players set corem.version corem.version %scoreboard_version%
...
tellraw @a ["",{"text":"One of your datapacks uses ","color":"gold"},{"text":"CoreM (%version%)","color":"red"},{"text":".","color":"gold"}]
