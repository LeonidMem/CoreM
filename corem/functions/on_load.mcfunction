scoreboard objectives add corem.bedrock minecraft.crafted:minecraft.bedrock {"text":"CoreM","color":"red"}
scoreboard objectives add corem.wbcrafted minecraft.crafted:minecraft.structure_block {"text":"CoreM","color":"red"}
scoreboard objectives add corem.random dummy {"text":"CoreM","color":"red"}
scoreboard objectives add corem.math dummy {"text":"CoreM","color":"red"}
scoreboard objectives add corem.version dummy {"text":"CoreM","color":"red"}
scoreboard objectives add corem.raycast dummy {"text":"CoreM","color":"red"}
scoreboard objectives add corem.const dummy {"text":"CoreM","color":"red"}
scoreboard objectives add corem.workbench dummy {"text":"CoreM","color":"red"}
