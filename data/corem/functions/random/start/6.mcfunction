...
execute as @e[type=minecraft:area_effect_cloud,tag=CoreMRandom,distance=..0.0000001] run function corem:random/check/6

kill @e[type=minecraft:area_effect_cloud,tag=CoreMRandom,limit=6]
