...
execute as @e[type=minecraft:area_effect_cloud,tag=CoreMRandom,distance=0] run function corem:random/check/7

kill @e[type=minecraft:area_effect_cloud,distance=..5,tag=CoreMRandom,limit=7]
