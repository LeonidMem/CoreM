...
execute positioned ~ ~-1 ~ if entity @s[distance=..1,tag=!corem.raycast.area,tag=!corem.raycast.mark,type=!#corem:1.15/raycast] positioned ~ ~1 ~ run function corem:raycast/end
